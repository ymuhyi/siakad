	...
	$content = "
				...
				<table cellpadding=0 border='0' cellspacing=0>
					<tr>
						...
						<th rowspan='2' align='center' width='130' style='border:1px solid #000; background-color: #9CCC68; padding: 2px;'>Kode Matakuliah</th>
						<th rowspan='2' align='center' width='250' style='border:1px solid #000; background-color: #9CCC68; padding: 2px;'>Mata Kuliah</th>
					...
					<tr bgcolor='#B7D577'>
						<th align='center' width='50' style='border-left: 1px solid; border-bottom: 1px solid;'>Huruf</th>
						<th align='center' width='50' style='border-left: 1px solid; border-bottom: 1px solid;'>Bobot</th>
					</tr>
			";
			$i = 1;
			$sql_sql = $db->database_prepare("SELECT B.sks_mata_kuliah, B.kode_mata_kuliah, B.nama_mata_kuliah_eng, C.semester, A.uts, A.uas, A.total, A.tugas, C.jadwal_id 
			...
			while ($data_nilai = $db->database_fetch_array($sql_sql)){
				...
				elseif ($nilai >= 50 AND $nilai <= 54){
					$mutu = "C-";
					$bobot = "1.75";
				}
				elseif ($nilai >= 45 AND $nilai <= 49){
					$mutu = "D";
					$bobot = "1";
				}
				elseif ($nilai < 45){

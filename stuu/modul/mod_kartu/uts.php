...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	foreach($check as $cek){
		...
		$content .= "
					...
					<table>
						<tr>
							<td align='center' width='600'><h4>Kartu Ujian Tengah Semester (UTS)</h4></td>
						</tr>
					</table>
					<table>
						<tr valign='top'>
				...
				$content .= "</table>
							<table>
								<tr>
									<td width='400'></td>
									<td align='center'><p>&nbsp;</p>Universitas ASFA Solution, <br>Kepala Program Studi<br><br><br><br>$data_mhs[NMDOSMSDOS] $data_mhs[GELARMSDOS]<br>NIP. <b>$data_mhs[NODOSMSDOS]</b></td>
								</tr>
							</table>
							<p>&nbsp;</p>
							";
